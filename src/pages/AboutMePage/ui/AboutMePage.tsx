...
const AboutMePage: FC = () => {
  return (
    <Container className="pt-12">
      ...
      <Text>
        Мой путь начался с классической вёрстки, после чего я постепенно освоил
        JavaScript и перешёл к современным фреймворкам. Сегодня я разрабатываю
        веб-приложения с использованием React, Next.js, TypeScript, Redux
        Toolkit, React Router и Zustand. Также имею опыт бэкенд-разработки на
        Node.js и Express, умею работать с базами данных. Проходил обучение на
        курсах, а также создавал собственные pet-проекты.
      </Text>
      <Text>
