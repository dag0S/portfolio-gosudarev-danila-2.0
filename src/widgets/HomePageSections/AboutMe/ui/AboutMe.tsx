  ...
  return (
    <SectionWithAnimation className={cn("flex items-center pt-32", className)}>
      <Container>
        ...
        <Text>
          Привет! Меня зовут{" "}
          <span className="text-primary font-bold">Данила Государев</span>, я
          Fullstack-разработчик с трёхлетним опытом. Моё увлечение
        ...
        <Text>
          ...
          разрабатываю веб-приложения с использованием React, NextJS,
          TypeScript, Redux Toolkit, React Router и Zustand. Также имею опыт
          бэкенд-разработки на Node.js, Express и NestJS, умею работать с базами
          данных. Проходил обучение на курсах, а также создавал собственные
          pet-проекты. Стажировался в компании МедГуру в качестве
